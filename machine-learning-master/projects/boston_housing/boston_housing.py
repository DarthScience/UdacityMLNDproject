...
def explore_city_data(city_data):
    ...
    NumberOfHouses = len(housing_prices)
    # Number of features?
    NumberOfFeatures = len(housing_features[0])
    # Minimum price?
    ...
    # print NumberOfHouses,NumberOfFeatures,MinPrice,MaxPrice,MeanPrice,MedianPrice,std
